...
describe('en-US locale', function() {
  context('with `format`', function() {
    ...
    it('era', function() {
      ...
      assert(result === 'MS, Milattan Sonra, S')
    })
    ...
    describe('quarter', function() {
      it('formatting quarter', function() {
        ...
        assert(result === '2. çeyrek, Q2, 2. çeyrek, 2')
      })
    ...
    describe('day', function() {
      it('ordinal date', function() {
        ...
        assert(result === "bugün 5'inci gün")
      })

      it('ordinal day of year', function() {
        var result = format(date, "'Senenin' Do 'günü'", { locale: locale })
        assert(result === "Senenin 95'inci günü")
      })
    })
  ...
  context('with `formatRelative`', function() {
    ...
    it('last week', function() {
      ...
      assert(result === 'geçen Salı saat 0:00')
    })
